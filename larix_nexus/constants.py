...
OPEN_ICON_PATH = rsrc_path("icon", "open.png").replace("\\", "/")
OPEN_LINK_ICON_PATH = rsrc_path("icon", "openlink.png").replace("\\", "/")
EDIT_ICON_PATH = rsrc_path("icon", "edit.png").replace("\\", "/")
DELETE_ICON_PATH = rsrc_path("icon", "delete.png").replace("\\", "/")
COPY_ICON_PATH = rsrc_path("icon", "copy.png").replace("\\", "/")
...
VERSION_ICON_PATH = rsrc_path("icon", "version.png").replace("\\", "/")
PROPERTIES_ICON_PATH = rsrc_path("icon", "properties.png").replace("\\", "/")
INFORMATION_ICON_PATH = rsrc_path("icon", "information.png").replace("\\", "/")
